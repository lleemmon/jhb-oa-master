...
import com.jhb.model.wechat.Menu;
import com.jhb.vo.wechat.MenuVo;
import com.jhb.wechat.mapper.MenuMapper;
import com.jhb.wechat.service.MenuService;
    ...
    public void syncMenu() {
        ...
        for(MenuVo oneMenuVo : menuVoList) {
            ...
            if(CollectionUtils.isEmpty(oneMenuVo.getChildren())) {
                ...
                one.put("url", "http://jhb.free.idcfengye.com/#"+oneMenuVo.getUrl());
            } else {
                ...
                for(MenuVo twoMenuVo : oneMenuVo.getChildren()) {
                    ...
                    if(twoMenuVo.getType().equals("view")) {
                        ...
                        //H5页面地址
                        view.put("url", "http://jhb.free.idcfengye.com#"+twoMenuVo.getUrl());
                    } else {
                        view.put("name", twoMenuVo.getName());
